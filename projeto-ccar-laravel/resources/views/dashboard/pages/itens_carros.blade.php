  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      <div class="col-md-3" style="float: right">
        {!! Form::open(['route'=>['iten.search'],'method'=>'post']) !!}
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="width: 10%" class="text-center">
              {!! Form::open(['route'=>['iten.destroy', $procura['id']],'method'=>'delete']) !!}
              <a type="button" id="btn-iten" class="btn btn-flat bg-gray" alt="editar"
              href="{{route('iten.edit',$procura['id'])}}"><i class="fa fa-pencil"></i></a>&nbsp;
            ...
            <tr>
              ...
              <td style="width: 10%" class="text-center">
                {!! Form::open(['route'=>['iten.destroy', $row['id']],'method'=>'delete']) !!}
                <a type="button" id="btn-iten" class="btn btn-flat bg-gray" alt="editar"
                href="{{route('iten.edit',$row['id'])}}"><i class="fa fa-pencil"></i></a>&nbsp;
                <button type="submit" id="btn-iten" class="btn btn-danger active btn-flat" alt="remover"><i
                  class="fa fa-trash-o"></i></button>
                  {!! Form::close() !!}
                </td>
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    {!! Form::open(['route'=>'iten.store','method'=>'post'] )!!}
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <div class="modal-body">
                      {!! Form::open(['route' => ['iten.update', Session::get('iten')['id']], 'method'=> 'put']) !!}
                      <div class="form-group @error('name') has-error @enderror" id="name_div">
                        {!! Form::text('name', Session::get('iten')['name'] , ['placeholder'=>'Nome do item', 'class' =>'form-control','id'=>'name']); !!}
                        @error('name')
                        <h5 id="name_erro" class="error">{{ $errors->first('name') }}</h5>
                        @enderror
                      </div>
                      <div class="form-group @error('type') has-error @enderror" id="type_div">
                        <div class="row">
                          <div class="col-md-4">
                            {!! Form::select('type',['Gasolina' => 'Gasolina','Alcool' => 'Alcool','Flex' => 'Flex',],Session::get('iten')['type'],['class'=> 'form-control','placeholder' => 'Combustivel','id'=>'type']) !!}
                          </div>
                        </div>
                        @error('type')
                        <h5 id="type_erro" class="error">{{ $errors->first('type') }}</h5>
