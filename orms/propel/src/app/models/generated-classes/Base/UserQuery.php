 ...
 * @method     ChildUserQuery orderBySenha($order = Criteria::ASC) Order by the senha column
 *
 * @method     ChildUserQuery groupById() Group by the id column
 * @method     ChildUserQuery groupByEmail() Group by the email column
 * @method     ChildUserQuery groupBySenha() Group by the senha column
 *
 ...
 * @method     ChildUser|null findOneBySenha(string $senha) Return the first ChildUser filtered by the senha column *
 ...
 * @method     ChildUser requireOneBySenha(string $senha) Return the first ChildUser filtered by the senha column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUser[]|ObjectCollection findBySenha(string $senha) Return ChildUser objects filtered by the senha column
 * @psalm-method ObjectCollection&\Traversable<ChildUser> findBySenha(string $senha) Return ChildUser objects filtered by the senha column
...
abstract class UserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, email, senha FROM users WHERE id = :p0';
        try {
    ...
    public function filterBySenha($senha = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_SENHA, $senha, $comparison);
    }
