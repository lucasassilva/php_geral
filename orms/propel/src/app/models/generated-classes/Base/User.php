...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setSenha($v)
    {
        ...
        if ($this->senha !== $v) {
            $this->senha = $v;
            $this->modifiedColumns[UserTableMap::COL_SENHA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserTableMap::translateFieldName('Senha', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_SENHA)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_SENHA)) {
            $criteria->add(UserTableMap::COL_SENHA, $this->senha);
        }
